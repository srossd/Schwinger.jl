...
@testset "Ground state and gap" begin
    @showprogress desc="ED vs MPO" for lat in [SchwingerLattice{10,1}(a = .7), SchwingerLattice{10,1}(a = .7, m = 0.5), 
        SchwingerLattice{10,1}(a = .7, m = 0.5, θ2π = 0.3), SchwingerLattice{6,2}(a = .7, m = 0.5, θ2π = 0.3), 
        SchwingerLattice{4,3}(a = .7, m = 0.5, θ2π = 0.3), SchwingerLattice{2,4}(a = .7, m = 0.5, θ2π = 0.3)]
        ...
        mpo_gap = energygap(MPOHamiltonian(lat); energy_tol=1E-8)
